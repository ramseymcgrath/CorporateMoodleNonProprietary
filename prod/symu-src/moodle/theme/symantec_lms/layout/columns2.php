...
?>
		...
		<?php $shownames = $PAGE->theme->settings->menushownames; ?>
			...
			<!--Feedback-->
			<a href="<?php echo $PAGE->theme->settings->menuitemfeedback; ?>" id="reportIcon"><img src="/theme/symantec_lms/pix/report.png" class="lms_menu_item" title="Report Issue" onclick="showFeedbackModal('<?php echo $USER->email; ?>')"/></a>
