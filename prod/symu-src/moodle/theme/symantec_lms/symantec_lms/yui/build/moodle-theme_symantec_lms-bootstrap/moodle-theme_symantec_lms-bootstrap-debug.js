...
YUI.add('moodle-theme_symantec_lms-bootstrap', function (Y, NAME) {

/**
The Moodle Bootstrap theme's bootstrap JavaScript

@namespace Moodle
@module theme_symantec_lms-bootstrap
**/

/**
The Moodle Bootstrap theme's bootstrap JavaScript

@class Moodle.theme_symantec_lms.bootstrap
@uses node
@uses selector-css3
@constructor
**/
var CSS = {
    ...
    NS = Y.namespace('Moodle.theme_symantec_lms.bootstrap');
